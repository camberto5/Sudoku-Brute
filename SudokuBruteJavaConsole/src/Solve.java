...
public class Solve {
    ...
    public static Puzzle solution = null;
     ...
     */
    private static void removeRowCandidates(int row, int col, Puzzle p) {
        for(int c = 0; c < 9; ++c) {
     ...
     * @param p - the puzzle that is being modified.
     */
    private static void removeColCandidates(int row, int col, Puzzle p) {
        for(int r = 0; r < 9; ++r) {
     ...
     * @param p - the puzzle that is being modified.
     */
    private static void removeSectorCandidates(int row, int col, Puzzle p) {
     ...
     * @param p - the puzzle that is being modified.
     */
    public static void buildCandidates(int row, int col, Puzzle p) {
     ...
     */
    public static boolean validateBoard(Puzzle p) {
        for(int i = 0; i < 9; ++i) {
     ...
     */
    public static boolean solvePuzzle(int row, int col, Puzzle p) {
        ++recursiveCalls;
        if(row == 8 && col == 8) {
    ...
    public static void main(String[] args) {
        ...
        solution.display();
        System.out.println("The puzzle was solved in " + (end - start) + "ms");
        System.out.println("The puzzle took " + recursiveCalls + " recursive calls to be solved.");
    }
